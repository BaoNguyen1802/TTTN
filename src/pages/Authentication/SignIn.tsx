...
import { setToken } from '../../reduxs/accounts/auth.slices';
...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (event: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      const response = await axios.post(env + '/api/v1/auth/login', {
        email: email,
        password: password,
      });

      const token = response.data;
      // Lưu token vào Redux Store nếu đăng nhập thành công
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block w-30" src={Logo} alt="Logo" />
                <img className="dark:hidden w-30" src={Logo} alt="Logo" />
              </Link>
